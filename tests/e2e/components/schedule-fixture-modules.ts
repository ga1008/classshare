...
export async function serveScheduleModule(route: Route): Promise<boolean> {
  ...
  if (!['course_schedule_deck.js', 'course_schedule_change_routes.js', 'course_schedule_change_links.js', 'course_schedule_presentation.js'].includes(module)) return false;
