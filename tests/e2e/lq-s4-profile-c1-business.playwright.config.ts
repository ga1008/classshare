...
const output = path.resolve(process.env.LQ_S4_C1_BUSINESS_OUTPUT || '.codex-temp/claude-s4-c1-e2e-business');
export default defineConfig({
  testDir: './specs', testMatch: ['lq-s4-profile-appearance-business.spec.ts'], workers: 1, fullyParallel: false,
