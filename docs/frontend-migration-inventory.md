...
> 生成时间：2026-06-02 07:51:17（Asia/Shanghai）。
...
| `frontend/src/islands/assignment-authoring-sync.tsx` | `assets/assignment-authoring-sync-dELcHes2.js` | `_mount-react-island-DEL8WbNn.js`, `_createLucideIcon-u9LDZDWz.js`, `_bell-_fFZyebH.js`, `_bot-BArN-TzV.js` 等 8 项 |
| `frontend/src/islands/assignment-submit-sync.tsx` | `assets/assignment-submit-sync-CPFFXhVa.js` | `_mount-react-island-DEL8WbNn.js`, `_island-payload-DC_mu5iS.js`, `_createLucideIcon-u9LDZDWz.js`, `_circle-alert-CvvlF6cH.js` 等 7 项 |
| `frontend/src/islands/assignment-task-board-sync.tsx` | `assets/assignment-task-board-sync-BhVU_nN5.js` | `_mount-react-island-DEL8WbNn.js`, `_createLucideIcon-u9LDZDWz.js`, `_book-open-check-D0cVMpRi.js`, `_circle-alert-CvvlF6cH.js` 等 7 项 |
...
| `frontend/src/islands/classroom-activity-workspace-sync.tsx` | `assets/classroom-activity-workspace-sync-CxjlVQBD.js` | `_mount-react-island-DEL8WbNn.js`, `_createLucideIcon-u9LDZDWz.js`, `_panels-top-left-Cs5bBmxe.js`, `_refresh-cw-BbXzb7Yt.js` |
| `frontend/src/islands/classroom-workspace-nav-sync.tsx` | `assets/classroom-workspace-nav-sync-D5RIAO-P.js` | `_mount-react-island-DEL8WbNn.js`, `_createLucideIcon-u9LDZDWz.js`, `_clipboard-list-BMZPN3Td.js`, `_panels-top-left-Cs5bBmxe.js` |
...
| `frontend/src/islands/teacher-submission-workbench-sync.tsx` | `assets/teacher-submission-workbench-sync-BppgsahJ.js` | `_mount-react-island-DEL8WbNn.js`, `_createLucideIcon-u9LDZDWz.js`, `_bot-BArN-TzV.js`, `_circle-check-BpXIs8GZ.js` 等 6 项 |

## 业务域覆盖图

| 业务域 | 模板数量 | 关键模板 | 关键脚本线索 |
| --- | ---: | --- | --- |
| 作业与提交 | 3 | `assignment_detail_student.html`, `assignment_detail_teacher.html`, `submission_detail.html` | `js/ui.js`, `js/submission_upload.js`, `js/assignment_time.js`, `js/review_docx_export.js`, `js/behavior_tracker.js`, `js/feedback.js` 等 13 项 |
...
| 消息、反馈、博客、个人中心 | 9 | `blog.html`, `feedback_review.html`, `message_center.html`, `partials/blog_button.html`, `partials/feedback_button.html`, `partials/feedback_modal.html` | `js/blog.js`, `js/feedback_review.js`, `js/message_center.js`, `js/echarts.min.js`, `js/profile.js` |
...
| 资料与文件 | 4 | `manage/materials.html`, `material_viewer.html`, `partials/learning_material_selector.html`, `partials/session_material_ai_modal.html` | `js/materials_manage.js`, `js/teacher_whiteboard.js`, `js/material_viewer.js`, `js/ai_chat_component.js`, `js/ai_workspace_widget.js` |
| 首页与课堂 | 4 | `classroom_main_v4.html`, `dashboard.html`, `learning_path.html`, `partials/semester_calendar_panel.html` | `js/tools.js`, `js/classroom_interactions.js`, `js/ai_workspace_widget.js`, `js/behavior_tracker.js`, `js/feedback.js`, `js/ui.js` 等 17 项 |
...
| `assignment_detail_teacher.html` | `base.html`, `partials/feedback_modal.html`, `partials/ai_workspace_widget.html`, `partials/markdown_assets.html` 等 5 项 | `css/exam_paper_preview.css`, `js/echarts.min.js`, `js/ai_chat_component.js`, `js/ai_workspace_widget.js`, `js/ui.js` 等 8 项 | `frontend/src/islands/teacher-submission-workbench-sync.tsx` | `teacher-submission-workbench-sync` |
...
| `classroom_main_v4.html` | `base.html`, `partials/markdown_assets.html`, `partials/student_security_modal.html`, `partials/feedback_modal.html` 等 8 项 | `js/tools.js`, `js/classroom_interactions.js`, `collaboration`, `js/ai_workspace_widget.js`, `js/behavior_tracker.js` 等 16 项 | `frontend/src/islands/classroom-workspace-nav-sync.tsx`, `frontend/src/islands/assignment-task-board-sync.tsx`, `frontend/src/islands/classroom-activity-workspace-sync.tsx` 等 8 项 | `classroom-workspace-nav-sync`, `learning-progress-sync`, `assignment-task-board-sync` 等 8 项 |
...
| `manage/materials.html` | `manage/layout.html`, `macros/app_topbar.html` | `js/materials_manage.js` | - | - |
...
| `message_center.html` | `base_navbar.html`, `partials/markdown_assets.html` | `js/message_center.js` | `frontend/src/islands/message-center-workspace-sync.tsx` | `message-center-workspace-sync` |
...
| `profile.html` | `base_navbar.html`, `partials/markdown_assets.html` | `js/echarts.min.js`, `js/profile.js`, `js/message_center.js` | `frontend/src/islands/message-center-workspace-sync.tsx` | `message-center-workspace-sync` |
...
| `classroom_app/routers/homework.py` | 31 | `POST /courses/{course_id}/assignments`, `PUT /assignments/{assignment_id}`, `DELETE /assignments/{assignment_id}`, `GET /assignments/time-state` 等 8 项 | - |
...
| `classroom_app/routers/manage.py` | 93 | `GET /teacher-onboarding/state`, `POST /teacher-onboarding/dismiss`, `POST /teacher-onboarding/classes/create`, `POST /teacher-onboarding/course-description` 等 8 项 | - |
| `classroom_app/routers/materials.py` | 37 | `GET /manage/materials`, `GET /api/materials/library`, `GET /api/materials/ai-generation/candidates`, `GET /api/materials/ai-generation/assignments` 等 8 项 | `manage/materials.html`, `material_viewer.html` |
...
| `classroom_app/routers/ui.py` | 43 | `GET /`, `GET /student/login`, `GET /teacher/login`, `GET /teacher/register` 等 8 项 | `student_login_v4.html`, `teacher_login_v4.html`, `status.html`, `permission_denied.html`, `dashboard.html` 等 31 项 |
...
| `js/classroom_page.js` | 184.7 KB | 1 |
| `js/chat.js` | 115.2 KB | 1 |
| `js/materials_manage.js` | 114.7 KB | 1 |
...
| `js/message_center.js` | 65.7 KB | 2 |
...
| `js/learning_progress.js` | 37.1 KB | 1 |
| `js/classroom_interactions.js` | 36.6 KB | 1 |
| `js/classroom_private_messages.js` | 35.7 KB | 1 |
