...
_TEACHER_ONLY_PATTERNS = (
    ...
    re.compile(r"^/api/materials/(?:library|upload|ai-import|ai-import-records(?:/active|/\d+/(?:status|export))?|[^/]+(?:/(?:assign|ai-parse|ai-optimize|ai-import/export|content|repository(?:/(?:command|credentials))?))?)$"),
)
