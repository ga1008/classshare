...
MESSAGE_CATEGORY_SIGNATURE = "signature_workflow"
...
CATEGORY_LABELS = {
    ...
    MESSAGE_CATEGORY_BLOG_CAREER: "就业机会",
    ...
    MESSAGE_CATEGORY_SIGNATURE: "签名审批",
    MESSAGE_CATEGORY_APPROVAL: "申请审批",
}
