...
STATIC_UI_COPY_SNAPSHOT: dict[str, dict[str, dict[str, str]]] = {
    "dashboard": {
        "teacher": {
            ...
            "quick_actions_subtitle": "开课、整理材料、题库与审核，一步直达。",
            "focus_title": "优先处理",
            "focus_subtitle": "最影响课堂节奏的事，先在这里收掉。",
            "focus_empty_title": "暂无紧急事项",
            "focus_empty_description": "可以趁现在补充材料、修订试卷，或查看课堂反馈。",
            "activity_title": "最近动态",
        ...
        "student": {
            ...
            "quick_actions_title": "快捷入口",
            "quick_actions_subtitle": "重点任务、消息中心与账号设置，一步直达。",
            "focus_title": "优先处理",
            "focus_subtitle": "眼下最要紧的事，先在这里收掉。",
            "activity_title": "最近动态",
            ...
            "empty_step_profile_description": "先把姓名、班级和联系方式看一眼，老师导入名单后更容易对上你。",
            "empty_step_profile_label": "去个人中心",
            "empty_step_classroom_title": "等待任课教师开课",
            "empty_step_classroom_description": "课堂由任课教师创建并导入班级名单，开课后入口会自动出现在首页。",
            "empty_step_message_title": "看看通知",
            "empty_step_message_description": "开课、作业和反馈提醒都会进入消息中心，可以先确认有没有新通知。",
