...
FINAL_MATERIAL_LAYOUTS: dict[str, dict[str, Any]] = {
    "assessment_plan": {
        "page": "A4 portrait",
        "margins_cm": {"top": 1.501, "bottom": 1.501, "left": 1.501, "right": 1.249, "footer": 1.75},
        "margins_twips": {"top": 851, "bottom": 851, "left": 851, "right": 708, "footer": 992},
        "title_font": {"name": "宋体", "size_pt": 18, "bold": True},
        "period_font": {"name": "宋体", "size_pt": 14, "bold": True},
        "body_font": {"name": "宋体", "size_pt": 10.5},
        "metadata_table_widths_cm": [4.636, 4.307, 4.249, 5.052],
        "metadata_table_grid_twips": [2628, 2442, 2409, 2864],
        "assessment_table_widths_cm": [4.636, 10.109, 3.499],
        "assessment_table_grid_twips": [2628, 5731, 1984],
        "metadata_row_height_cm": 1.105,
        "metadata_row_heights_twips": [626, 629, 629, 624],
        "assessment_header_height_cm": 1.15,
        "assessment_header_height_twips": 652,
        "assessment_body_min_height_cm": 2.0,
        "assessment_body_height_twips": 1134,
    },
    "grading_rubric": {
        "page": "A4 portrait",
