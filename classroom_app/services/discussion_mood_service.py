        ...
        response = await ai_client.post(
            ...
            json={
                "system_prompt": (
                    ...
                    "语气可以撒欢、唱歌、感伤、热血、发呆、轻微中二，但不要攻击任何人。"
                ),
                "messages": [],
...
def _build_generation_prompt(
    *,
    ...
    return (
        ...
        "2. headline 和 detail 都必须是单行短句，最好像两句小诗、两句歌词味道、两句碎碎念。\n"
        "3. 重点参考老师最近发言的情绪，但不必太准确，可以夸张一点、戏剧化一点、可爱一点。\n"
        "4. 可以写得撒欢、发呆、悲伤、痛苦、热血、唱歌、松弛，但不要阴阳怪气，不要点名羞辱任何人。\n"
        "5. 不要写成功能说明，不要写操作步骤，不要提 AI、系统、提示词、内部分析。\n"
        "6. 可以有流行歌词或周杰伦、邓紫棋那种氛围感，但请尽量原创或轻微改写，不要照搬长歌词。\n"
        "7. 每句尽量控制在 8-26 个汉字内，适合直接展示给全班看。\n\n"
        f"当前时间：{now_text}\n"
