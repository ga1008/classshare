...
MANAGE_NAV_ITEMS: tuple[ManageNavItem, ...] = (
    ...
    ManageNavItem(
        ...
        label="基础资料",
        icon="user",
        href="/manage/me/settings",
        search_text="基础资料 头像 心情 简介 联系方式 profile settings",
    ...
    ManageNavItem(
        ...
        label="账号安全",
        icon="lock",
        href="/manage/me/security",
        search_text="账号安全 修改密码 登录记录 security password",
        ai_hint="账号安全：修改密码、查看登录安全信息。",
    ),
    ManageNavItem(
        ...
        label="通知与私信",
        icon="message-circle",
        href="/manage/me/notifications",
        search_text="通知 私信 消息中心 notifications message center",
        ai_hint="通知与私信：消息中心，集中处理系统通知与一对一私信。",
    ),
    ManageNavItem(
        key="me_email",
        domain=MANAGE_ME_DOMAIN,
        ...
        label="邮箱通知",
        icon="refresh",
        href="/manage/me/email",
        search_text="邮箱 发信 邮件提醒 SMTP email",
        ai_hint="邮箱通知：配置教师发信邮箱，用于作业、考试与监考的邮件提醒。",
    ),
    ManageNavItem(
        key="signatures",
        domain=MANAGE_ME_DOMAIN,
