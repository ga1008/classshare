...
from .schema_ai_workspace import AI_WORKSPACE_REQUIRED_COLUMNS
...
REQUIRED_POSTGRES_COLUMNS = {
    ...
    **AI_JOB_REQUIRED_POSTGRES_COLUMNS,
    ...
    "user_ui_preferences": ("user_role", "user_pk", "palette_key", "appearance", "glass", "backdrop", "backdrop_color", "version", "updated_at"),
