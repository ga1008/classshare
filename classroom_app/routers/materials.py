...
from .materials_parts import academic_final_materials as _academic_final_materials
...
from .materials_parts.academic_final_materials import *
...
router.include_router(_academic_final_materials.router)
